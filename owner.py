...
food_menu= [
    {
        "category": "main_meal",
        "items": [
            {"name": "Burger", "price": 120, "stock_quantity": 10},
            {"name": "Pizza", "price": 200, "stock_quantity": 5},
            {"name": "Pasta", "price": 150, "stock_quantity": 8}
        ]
    },
    {
        "category": "fast_food",
        "items": [
            {"name": "Sandwich", "price": 80, "stock_quantity": 12},
            {"name": "Fries", "price": 60, "stock_quantity": 20}
        ]
    },
    {
        "category": "drinks",
        "items": [
            {"name": "Juice", "price": 50, "stock_quantity": 15},
            {"name": "Soda", "price": 40, "stock_quantity": 25}
        ]
    }
]
...
orders = [
    {
        ...
        "phone": "0912345678",
        "items": [
            {"name": "Burger", "price": 120, "quantity": 2, "subtotal": 240},
            {"name": "Pizza", "price": 200, "quantity": 1, "subtotal": 200}
        ],
        "total": 440,
        "paid": True,
        "status": "Completed"
    },
    {
        ...
        "phone": "0987654321",
        "items": [
            {"name": "Sandwich", "price": 80, "quantity": 3, "subtotal": 240}
        ],
        "total": 240,
        "paid": True,
        "status": "Pending"
    },
    {
        ...
        "phone": "0911223344",
        "items": [
            {"name": "Pasta", "price": 150, "quantity": 2, "subtotal": 300},
            {"name": "Juice", "price": 50, "quantity": 2, "subtotal": 100}
        ],
        "total": 400,
        "paid": False,
        "status": "Pending"
...
def owner_login():
    passkey = input("Enter the password: ").strip()
    ...
    while True:
        ...
        try:
            ...
            if choice==0:
                ...
                try:
                    category=int(input("Enter the index of food Category: "))
...
def update_food_price(food_menu):
...
def update_food_stock(food_menu):
...
def view_orders(orders):
    ...
    for order in orders:
        ...
        for item in order['items']:
            ...
            print(f"Half-payment-{item['subtotal']}")
...
def owner_flow(food_menu,orders):
    ...
    while True:
        ...
        try:
            ...
            print("Enter from the choice only")
            continue
        if choice == 0:
            break
        elif choice == 1:
            ...
            if authentication:
                ...
                while True:
                    ...
                    if choice==1:
                        ...
                        delete_food(food_menu)
        
                    elif choice ==3:
                        update_food_price(food_menu)
       
                    elif choice ==4:
                        update_food_stock(food_menu)
